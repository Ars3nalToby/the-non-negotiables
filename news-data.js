...
const NEWS = [
  ...
  {date:'2026-09-17', headline:'Fourth-round draw sends Arsenal to Fleetwood — at a ground called Highbury',
   summary:'The luck of the pot, delivered as only English football can: League Two’s bottom-tier survivors are the visitors’ reward in the Carabao Cup, at a stadium that has carried the same name as Arsenal’s old home for over a century, pure coincidence and all. Fleetwood got here by knocking out fellow fourth-tier sides Chesterfield and Shrewsbury before beating Championship promotion-chasers Sheffield United in round three, so this is an underdog with actual scalps rather than a gentle draw. The tie is pencilled in for the week commencing 26 October, the first competitive meeting between the two clubs.',
   source:'Sky Sports', url:'https://www.skysports.com/football/news/11938/13588651/carabao-cup-fourth-round-draw-liverpool-to-host-chelsea-as-arsenal-drawn-away-to-league-two-fleetwood'},
