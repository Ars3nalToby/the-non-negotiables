...
const SQUAD = [
  {no:1, pos:'GK', name:'David Raya', from:'Spain', ig:null, x:null},
  {no:2, pos:'DF', name:'William Saliba', from:'France', ig:'wsaliba4', x:null},
  {no:3, pos:'DF', name:'Myles Lewis-Skelly', from:'England', ig:null, x:null},
  {no:4, pos:'DF', name:'Ben White', from:'England', ig:null, x:null},
  {no:5, pos:'MF', name:'Bruno Guimar\u00e3es', from:'Brazil \u00b7 new', ig:null, x:null},
  {no:6, pos:'DF', name:'Gabriel Magalh\u00e3es', from:'Brazil', ig:null, x:null},
  {no:7, pos:'FW', name:'Bukayo Saka', from:'England', ig:'bukayosaka87', x:null},
  {no:8, pos:'MF', name:'Martin \u00d8degaard', from:'Norway \u00b7 captain', ig:'odegaard.98', x:null},
  {no:9, pos:'FW', name:'Viktor Gy\u00f6keres', from:'Sweden', ig:null, x:null},
  {no:10,pos:'MF', name:'Eberechi Eze', from:'England', ig:null, x:null},
  {no:12,pos:'DF', name:'Jurri\u00ebn Timber', from:'Netherlands', ig:null, x:null},
  {no:13,pos:'GK', name:'Illan Meslier', from:'France \u00b7 new', ig:null, x:null},
  {no:14,pos:'FW', name:'Christos Tzolis', from:'Greece \u00b7 new', ig:null, x:null},
  {no:15,pos:'MF', name:'Mart\u00edn Zubimendi', from:'Spain', ig:null, x:null},
  {no:16,pos:'DF', name:'Piero Hincapi\u00e9', from:'Ecuador', ig:null, x:null},
  {no:17,pos:'DF', name:'Riccardo Calafiori', from:'Italy', ig:null, x:null},
  {no:18,pos:'DF', name:'Ezri Konsa', from:'England \u00b7 new', ig:null, x:null},
  {no:19,pos:'MF', name:'Declan Rice', from:'England', ig:'declanrice', x:null},
  {no:20,pos:'FW', name:'Kai Havertz', from:'Germany', ig:null, x:null},
  {no:21,pos:'MF', name:'Mikel Merino', from:'Spain', ig:null, x:null},
  {no:23,pos:'FW', name:'Noni Madueke', from:'England', ig:null, x:null},
  {no:0, pos:'MGR',name:'Mikel Arteta', from:'Manager since 2019', ig:null, x:null}
];
